...
export default function Banner3() {
  return (
    <div className="flex h-[85vh] w-full flex-col bg-pink-800 md:aspect-[17/8] md:h-auto md:flex-row ">
      <img
      ...
      />
      <div className="relative flex grow flex-col items-center justify-center gap-4 bg-pink-800 px-4 md:bottom-0 md:order-1 md:w-[40%] md:items-end">
        <div className=" absolute bottom-[100%] h-[40px] w-full bg-gradient-to-t from-pink-800 to-transparent md:bottom-0 md:left-[100%] md:h-full md:w-[20%] md:bg-gradient-to-r"></div>
        <p className="text-center font-fredoka text-xl font-semibold text-white md:text-right lg:text-2xl">
